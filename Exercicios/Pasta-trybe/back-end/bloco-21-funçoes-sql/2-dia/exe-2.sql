-- 1 Queremos saber o Nome das pessoas colaboradoras e suas 
-- respectivas gerências (manager) cujos departamentos 
...
-- 2 Exiba o Nome e a quantidade de pessoas lideradas de 
-- cada pessoa gerente.
